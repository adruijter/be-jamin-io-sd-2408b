                    ...
                    @forelse ($products as $product)
                        <tr>
                            ...
                            <td class="text-center">
                                <form action="{{ route('product.allergeenInfo', $product->Id) }}" method="POST">                                    
                                    @csrf
                                    @method('GET')
                                    <button type="submit" class="btn btn-secondary btn-sm">Allergenen</button>
                                </form>
                            </td>
                            <td class="text-center">
                                <form action="{{ route('product.leverantieInfo', $product->Id) }}" method="POST">
                                    @csrf
                                    @method('GET')
                                    <button type="submit" class="btn btn-warning btn-sm">Leverantie</button>
                                </form>
                            </td>
                        </tr>
                    @empty
